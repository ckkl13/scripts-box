...
def show_scripts_box():
    ...
    from core.utils.qt_compat import cmds, QApplication, QDialog, setup_high_dpi_support
    from core.ui.main_window import ScriptsBox
    
    # 设置高DPI支持（在创建QApplication之前调用）
