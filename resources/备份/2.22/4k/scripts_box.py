...
class ScriptsBox(QDialog):
    ...
    def create_ui(self):
        ...
        clear_search_btn.setFixedSize(56, 32)
    ...
    def show_group(self, group_id):
        ...
        self.recycle_bin_visible = False
        self.recycle_bin_btn.setStyleSheet("QPushButton { text-align: left; padding: 8px 12px; border-radius: 6px; }")
...
"""
    ...
    def apply_settings(self, single_layout_selected, sidebar_enabled, dock_enabled, dialog):
        """应用设置"""
        # 获取当前布局模式
        ...
        if old_dock != dock_enabled:
            self.switch_dock_mode(dock_enabled)
            dialog.accept()
    ...
    def apply_sidebar_layout_styles(self):
        ...
        if getattr(self, "nav_widget", None):
            if mode:
                ...
                self.nav_layout.setContentsMargins(4, 6, 4, 6)
