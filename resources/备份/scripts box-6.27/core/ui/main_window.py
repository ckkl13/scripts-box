...
class ScriptsBox(QDialog):
    def __init__(self, parent=maya_main_window()):
        ...
        # 配置文件在 core/configuration/ 目录下
        self.config_file = os.path.join(self.core_dir, "configuration", "config.json")
        self.pinned_file = os.path.join(self.core_dir, "configuration", "pinned.json")
        self.groups_order_file = os.path.join(self.core_dir, "configuration", "groups_order.json")
        # 回收站目录
